...
<section class="mt-16 max-[1024px]:mt-5 mb-36 max-[1024px]:mb-28 max-[570px]:mb-15">
  <div class="flex max-[768px]:flex-col justify-between max-[1024px]:items-center gap-15 max-[1024px]:gap-6 max-[1240px]:gap-8 container">
    ...
    <div data-da=".hero, 767, 3" class="max-[768px]:mb-10 pt-8 w-full">
      ...
      <div class="relative bg-primary pt-12 max-[1024px]:pt-6 max-[430px]:pt-6 max-[768px]:pt-12 pr-68 max-[1024px]:pr-22 max-[1240px]:pr-32 max-[430px]:pr-20 max-[570px]:pr-32 max-[768px]:pr-57 pb-15 max-[1240px]:pb-20 max-[768px]:pb-15 pl-8 max-[1024px]:pl-5 max-[430px]:pl-5 max-[768px]:pl-8 rounded-[20px] text-white">
    ...
    <div class="flex max-[768px]:flex-col items-stretch gap-6 max-[1024px]:gap-4">
      <div class="bg-primary p-10 rounded-[30px]">
        ...
        <div class="flex items-center gap-1 font-bold text-[84px] text-white max-[768px]:text-[84px] max-[1024px]:text-5xl max-[1240px]:text-6xl max-[570px]:text-6xl leading-none">
          <div class="max-[570px]:z-1 bg-gray border-[#737373] border-2 rounded-full size-18 max-[1024px]:size-13 max-[1240px]:size-15 max-[570px]:size-15 max-[768px]:size-18 overflow-hidden"></div>
          <div class="max-[570px]:z-2 bg-gray max-[570px]:-ml-4 border-[#737373] border-2 rounded-full size-18 max-[1024px]:size-13 max-[1240px]:size-15 max-[570px]:size-15 max-[768px]:size-18 overflow-hidden"></div>
          <div class="max-[570px]:z-3 bg-gray max-[570px]:-ml-4 border-[#737373] border-2 rounded-full size-18 max-[1024px]:size-13 max-[1240px]:size-15 max-[570px]:size-15 max-[768px]:size-18 overflow-hidden"></div>
          <div class="max-[570px]:z-4 bg-gray max-[570px]:-ml-4 border-[#737373] border-2 rounded-full size-18 max-[1024px]:size-13 max-[1240px]:size-15 max-[570px]:size-15 max-[768px]:size-18 overflow-hidden"></div>
          +
        </div>
      </div>
      <div class="relative flex justify-center items-center bg-[#C7C7C7] mr-6 max-[1024px]:mr-0 rounded-[30px] w-full max-[768px]:aspect-square">
        <span class="max-[1024px]:hidden px-10 font-bold text-white text-5xl uppercase tracking-wider">
          HOW WE WORK
        </span>
