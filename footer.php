    ...
    <footer class="mt-10 py-10">
      <div class="flex max-[1024px]:flex-col justify-between items-start gap-20 container">
        <div>
          ...
          <p class="mb-8 max-w-xl font-medium text-pretty text-secondary text-sm leading-[1.8]">
          ...
          <div class="flex items-center gap-3">
            <a ontouchstart href="https://www.facebook.com/" class="rounded-full">
              <img src="<?php echo get_parent_theme_file_uri( 'assets/img/icons/facebook.svg' ) ?>" alt="">
            </a>
            <a ontouchstart href="https://x.com/" class="rounded-full">
              <img src="<?php echo get_parent_theme_file_uri( 'assets/img/icons/twitter.svg' ) ?>" alt="">
            </a>
            <a ontouchstart href="https://www.linkedin.com/" class="rounded-full">
              <img src="<?php echo get_parent_theme_file_uri( 'assets/img/icons/linkedin.svg' ) ?>" alt="">
            </a>
            <a ontouchstart href="https://www.instagram.com/" class="rounded-full">
              <img src="<?php echo get_parent_theme_file_uri( 'assets/img/icons/instagramm.svg' ) ?>" alt="">
            </a>
          </div>
        </div>
        <div class="flex max-[1024px]:flex-wrap max-[1024px]:justify-between max-[570px]:justify-start items-start gap-24 max-[1240px]:gap-15 max-[375px]:gap-x-15 max-[570px]:gap-x-24 max-[1024px]:w-full shrink-0">
          <div>
            <p class="mb-8 font-bold text-lg">
              Navigation
            </p>
            <ul class="flex flex-col gap-5 font-medium text-secondary text-sm">
                <li><a ontouchstart href="/#agency" class="">Agency</a></li>
                <li><a ontouchstart href="/#case-study" class="">Case study</a></li>
                <li><a ontouchstart href="/#testimonials" class="">Testimonials</a></li>
                <li><a ontouchstart href="/#faq" class="">FAQ’s</a></li>
                <li><a ontouchstart href="/#resources" class="">Resources</a></li>
              </ul>
          </div>
          <div>
            <p class="mb-8 font-bold text-lg">
            ...
            <ul class="flex flex-col gap-5 font-medium text-secondary text-sm">
                <li><a ontouchstart href="/#agency" class="">Ai Wave</a></li>
                <li><a ontouchstart href="/#case-study" class="">App Lancer</a></li>
                <li><a ontouchstart href="/#testimonials" class="">VbStudio</a></li>
              </ul>
          </div>
          <div>
            <p class="mb-8 font-bold text-lg">
            ...
            <ul class="flex flex-col gap-5 font-medium text-secondary text-sm">
              <li>
                <a ontouchstart href="4065550120" class="flex items-center gap-2">
                  <img src="<?php echo get_parent_theme_file_uri( 'assets/img/icons/phone.svg' ) ?>" alt="">
                  <span>(406) 555-0120</span>
                </a>
              </li>
              <li>
                <a ontouchstart href="Hey@boostim.com" class="flex items-center gap-2">
                  <img src="<?php echo get_parent_theme_file_uri( 'assets/img/icons/gmail.svg' ) ?>" alt="">
                  <span>Hey@boostim.com</span>
                </a>
              </li>
              <li class="w-[200px]">
                <a ontouchstart href="https://www.google.pl/maps" class="flex items-start gap-2">
                  <img src="<?php echo get_parent_theme_file_uri( 'assets/img/icons/location.svg' ) ?>" alt="">
